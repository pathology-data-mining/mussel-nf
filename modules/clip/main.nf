...
process ANNOTATE {
    ...
    publishDir path: "$params.outdir/annotate/${model_type}/", mode: "${params.publish_mode}"
...
process CACHE_TILES {
    ...
    publishDir path: "$params.outdir/cache_tiles/${model_type}/", mode: "${params.publish_mode}"
