...
# ---------------------------------------------------------------------------
# Helper functions (NF log parsing, SLURM stats, S3 stats)
# ---------------------------------------------------------------------------
import importlib as _il
_helpers_spec = _il.util.spec_from_file_location(
    "dashboard_helpers", Path(__file__).parent / "dashboard_helpers.py"
)
_helpers = _il.util.module_from_spec(_helpers_spec)
...
# ---------------------------------------------------------------------------
# HTML template — loaded from dashboard.html at startup
# ---------------------------------------------------------------------------
